          ...
          <div className="flex items-center px-6 sm:px-8 md:px-16 py-14 md:py-24">
            <div className="w-full text-center">
              ...
              <motion.p
                ...
                className="font-elegant text-[15px] sm:text-base md:text-lg text-foreground/55 md:text-foreground/45 leading-[1.9] md:leading-[2] tracking-wide max-w-xl mx-auto"
              >
                {t("brunch.about.p1")}
              </motion.p>
